        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="mx-auto max-w-6xl">
            <div className="grid md:grid-cols-2 gap-12">
              {/* Booking */}
              <div>
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Book Your Discovery Call</h2>
                <div className="mb-8">
                ...
                <div className="bg-blue-50 p-6 rounded-lg border border-blue-200 mb-8">
                  <p className="text-gray-700">
                    <strong>Prefer email first?</strong> That's fine too. Scroll down to the contact form.
                  </p>
                </div>
                ...
                <form className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      name="name"
                      required
                      className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-brand focus:outline-none focus:ring-2 focus:ring-blue-100"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      name="message"
                      rows={5}
                      className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-brand focus:outline-none focus:ring-2 focus:ring-blue-100 resize-none"
                  ...
                  <button
                    type="submit"
                    className="w-full px-6 py-3 rounded-lg bg-brand text-white font-medium hover:bg-brand-dark transition"
                  >
                    Send Message
                  </button>
                </form>
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-gray-700">
                  <a href="mailto:hello@vibecoach.com" className="text-brand hover:text-brand-dark transition">
                    hello@vibecoach.com
                  </a>
                </p>
              ...
              <div>
                ...
                <p className="text-gray-700">Philadelphia, PA</p>
                <p className="text-sm text-gray-600 mt-2">Available for in-person meetings.</p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  <a href="/contact" className="text-brand hover:text-brand-dark transition">
                    Book a discovery call
                  </a>
                </p>
                <p className="text-sm text-gray-600 mt-2">30 minutes, free, no obligation.</p>
              </div>
            </div>
          </div>
        </section>
