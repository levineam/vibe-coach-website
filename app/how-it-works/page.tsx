    ...
    <>
      ...
      <main>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-3 text-gray-700">
                  <p>
                    <strong>What we do:</strong> We ask questions. Lots of them. We want to understand your work, your goals, and your current relationship with AI.
                  </p>
                  ...
                  <p className="mt-4">
                    <strong>What you get:</strong> A clear picture of whether coaching is a fit. We're transparent: if it's not a match, we'll tell you.
                  </p>
                </div>
              </div>
              <div className="bg-blue-50 p-8 rounded-lg border-l-4 border-brand">
                ...
                <p className="font-semibold text-gray-900">— Early Customer</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
          <div className="mx-auto max-w-4xl">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="bg-white p-8 rounded-lg border-l-4 border-brand order-2 md:order-1">
                <div className="bg-blue-50 p-6 rounded mb-4">
                ...
                <p className="text-gray-700 text-sm">
                  <strong>In the strategy session, we'd:</strong> Build an automated workflow in your OpenClaw setup that reads emails, extracts key info, and creates summaries. You'd go from 3 hours to 15 minutes.
                </p>
              </div>
              <div className="order-1 md:order-2">
                ...
                <div className="space-y-4 text-gray-700">
                  <p>
                    <strong>What happens:</strong> We dive deep into your work and build a custom plan.
                  </p>
                  <ul className="space-y-2 ml-4">
                  ...
                  <p className="mt-4">
                    <strong>You leave with:</strong> A clear roadmap, a working AI system, and next steps.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-4xl">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-700">
                  <p>
                    <strong>What we do:</strong> Stay connected. Regular check-ins keep you accountable and help you iterate.
                  </p>
                  <ul className="space-y-2 ml-4">
                  ...
                  <p className="mt-4">
                    <strong>The goal:</strong> You stay confident, informed, and ahead of the curve.
                  </p>
                </div>
              </div>
              <div className="bg-blue-50 p-8 rounded-lg border-l-4 border-brand">
                <p className="text-gray-700 text-sm mb-4">
                  <strong>Typical coaching session:</strong>
                </p>
                <ul className="space-y-3 text-sm text-gray-700">
                  <li><strong>5 min:</strong> How's the workflow doing? Anything broke?</li>
                  <li><strong>15 min:</strong> I share a new AI capability that might help you</li>
                  <li><strong>20 min:</strong> We tackle your current blocker or question</li>
                  <li><strong>10 min:</strong> Set goals for next week/month</li>
                </ul>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-8 space-y-6">
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Your Personal AI Operating System</h3>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-blue-50 p-4 rounded">
                  <h4 className="font-semibold text-gray-900 mb-2">What you CAN do with OpenClaw:</h4>
                ...
                <div className="bg-amber-50 p-4 rounded">
                  <h4 className="font-semibold text-gray-900 mb-2">What you CAN'T do:</h4>
                  <ul className="space-y-2 text-sm text-gray-700">
              ...
              <div className="bg-blue-50 p-4 rounded">
                <p className="text-sm text-gray-700">
                  <strong>Bottom line:</strong> OpenClaw is a tool for people who want control. In coaching, we set it up together and you maintain it. It's not required, but it's the backbone of what we teach.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="space-y-6">
              <div className="flex gap-6">
                ...
                <div className="flex-grow">
                  <h4 className="font-semibold text-gray-900 mb-2">Month 1: Foundation</h4>
                  <p className="text-gray-700">
              ...
              <div className="flex gap-6">
                ...
                <div className="flex-grow">
                  <h4 className="font-semibold text-gray-900 mb-2">Month 2: Expansion</h4>
                  <p className="text-gray-700">
              ...
              <div className="flex gap-6">
                ...
                <div className="flex-grow">
                  <h4 className="font-semibold text-gray-900 mb-2">Month 3: Mastery</h4>
                  <p className="text-gray-700">
            ...
            <div className="mt-8 p-6 bg-green-50 rounded-lg border border-green-200">
              <p className="text-gray-700">
                <strong>By the end:</strong> You've saved 5+ hours per week, built a personal AI system that works for you, and gained the confidence to adopt new AI tools independently.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white p-6 rounded-lg border border-gray-200">
                <h3 className="text-xl font-semibold text-gray-900 mb-4 text-red-600">❌ NOT Just Chat</h3>
              ...
              <div className="bg-white p-6 rounded-lg border-2 border-green-500">
                <h3 className="text-xl font-semibold text-gray-900 mb-4 text-green-600">✓ REAL Coaching</h3>
                <ul className="space-y-2 text-gray-700">
